  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <div className="flex flex-1 overflow-hidden">
        <Sidebar />
        <main className="flex-1 flex flex-col bg-background-base relative overflow-hidden m-2 ml-0 rounded-lg">
          <div className="absolute inset-0 bg-gradient-to-b from-indigo-900/40 to-background-base pointer-events-none" />
          <Navbar />
          <div className="flex-1 overflow-y-auto relative scroll-smooth">
            <Outlet />
            <footer className="p-8 mt-12 border-t border-white/5 text-text-subdued text-sm">
